const KPI_DEFINITIONS = {
    ...
    "BiG Checks": {
        ...
        createFormula: (startDate, endDate) => (apiData) => {
            ...
            return bigChecks.length / numWeeks;
        },
        redFlag: 4,
        target: 5,
    ...
    "ROAS Actualized": {
        ...
        dataKeys: ["profit", "marketingExpenses"],
        formula: (apiData) => {
        ...
        redFlag: 0,
        target: 0,
        dataLabels: ["Actualized Profit: ", "Ad Spend: "],
        kpiFactors: [
            {
                id: 0,
    ...
    "ROAS Projected": {
        name: "ROAS Projected",
        dataKeys: [ "projectedProfit", "marketingExpenses"],
        formula: (apiData) => {
        ...
        redFlag: 0,
        target: 0,
        dataLabels: ["Projected Profit: ", "Ad Spend: "],
        kpiFactors: [
            {
                id: 0,
    ...
    "ROAS Total": {
        name: "ROAS Total",
        dataKeys: ["totalProfit", "marketingExpenses"],
        formula: (apiData) => {
        ...
        redFlag: 0,
        target: 0,
        dataLabels: ["Total Profit: ", "Ad Spend: "],
        kpiFactors: [
            {
                id: 0,
