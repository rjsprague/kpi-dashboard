...
async function fetchKpiData(kpiView, requestedKpiList, leadSource, gte, lte, department, teamMember) {
  
  //console.log("kpiView ", kpiView);
  //console.log("Requested KPI List ", requestedKpiList[0]);
  ...
  if (kpiView === "Team" && department[0] === "Lead Manager") {
    kpiList = requestedKpiList[0]['Lead Manager']
    //console.log("kpi list ", kpiList)
  } else if (kpiView === "Team" && department[0] === "Acquisition Manager") {
    kpiList = requestedKpiList[0]['Acquisition Manager']
    //console.log("kpi list ", kpiList)
  } else {
