...
async function fetchKpiData(leadSource, gte, lte) {

  try {
    const startDate = gte ? formatDate(new Date(gte)) : null;
    const endDate = lte ? formatDate(new Date(lte)) : null;

    console.log("lead source length ", leadSource.length);
    ...
    const generateFilters = (fieldName, dateFieldName, extraFilters) => {
      ...
      if (leadSource && leadSource !== null && leadSource.length > 0) {
        filters.push({
          "type": "app",
          "fieldName": fieldName,
          "values": leadSource,
    ...
    const perfectPresentationRatio = approvedTriageCalls !== 0 ? Math.round(perfectPresentations / dealsApproved * 100) : 0;
    ...
    // Console log all values and each operation to make sure they are correct
    console.log("marketingExpenses", marketingExpenses);
    console.log("leads", leads);
    console.log("Cost Per Lead is: " + marketingExpenses / leads + " Rounded: " + Math.round(marketingExpenses / leads));

    console.log("connectedLeads", connectedLeads);
    console.log("Connected Lead Ratio is: " + connectedLeads / leads);
    console.log("Connected Lead Ratio is: " + connectedLeads / leads * 100 + "% Rounded: " + Math.round(connectedLeads / leads * 100) + "%");

    console.log("triageCalls", triageCalls);
    console.log("Triage Call Ratio is: " + triageCalls / connectedLeads);
    console.log("Triage Call Ratio is: " + triageCalls / connectedLeads * 100 + "% Rounded: " + Math.round(triageCalls / connectedLeads * 100) + "%");
    
    console.log("qualifiedTriageCalls", qualifiedTriageCalls);
    console.log("Qualified Triage Call Ratio is: " + qualifiedTriageCalls / triageCalls);
    console.log("Qualified Triage Call Ratio is: " + qualifiedTriageCalls / triageCalls * 100 + "% Rounded: " + Math.round(qualifiedTriageCalls / triageCalls * 100) + "%");

    console.log("approvedTriageCalls", approvedTriageCalls);
    console.log("Approved Triage Call Ratio is: " + approvedTriageCalls / qualifiedTriageCalls);
    console.log("Approved Triage Call Ratio is: " + approvedTriageCalls / qualifiedTriageCalls * 100 + "% Rounded: " + Math.round(approvedTriageCalls / qualifiedTriageCalls * 100) + "%");
    
    console.log("dealsApproved", dealsApproved);
    console.log("Deal Analysis Ratio is: " + dealsApproved / approvedTriageCalls);
    console.log("Deal Analysis Ratio is: " + dealsApproved / approvedTriageCalls * 100 + "% Rounded: " + Math.round(dealsApproved / approvedTriageCalls * 100) + "%");

    console.log("perfectPresentations", perfectPresentations);
    console.log("Perfect Presentation Ratio is: " + perfectPresentations / dealsApproved);
    console.log("Perfect Presentation Ratio is: " + perfectPresentations / dealsApproved * 100 + "% Rounded: " + Math.round(perfectPresentations / dealsApproved * 100) + "%");
    
    console.log("contracts", contracts);
    console.log("Contract Ratio is: " + contracts / perfectPresentations);
    console.log("Contract Ratio is: " + contracts / perfectPresentations * 100 + "% Rounded: " + Math.round(contracts / perfectPresentations * 100) + "%");
    
    console.log("acquisitions", acquisitions);
    console.log("Acquisition Ratio is: " + acquisitions / contracts);
    console.log("Acquisition Ratio is: " + acquisitions / contracts * 100 + "% Rounded: " + Math.round(acquisitions / contracts * 100) + "%");
