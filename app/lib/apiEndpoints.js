...
const apiEndpoints = (startDate, endDate, leadSources, kpiView, teamMembers, closers, setters) => {
    ...
    return {
        ...
        closersLeadsTriaged: {
            ...
            filters: generateFilters("Closers Leads Triaged", startDate, endDate, leadSources, kpiView, "Related Lead Source Item", "created_on", null, [
                {
                    "type": "category",
        ...
        closersLeadsSetPrequalified: {
            ...
            url: "/api/closers/acquisitions/setter-calls",
            filters: generateFilters("Closers LSP", startDate, endDate, leadSources, kpiView, "Related Lead Source Item", "created_on", null, [
                {
                    "type": "category",
                    "fieldName": "Qualification",
                    "values": ["Qualified"]
