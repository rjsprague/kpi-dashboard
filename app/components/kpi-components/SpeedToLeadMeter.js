...
const Dial = ({ target, redFlag, max, value, unit }) => {
    ...
    const redFlagLabel = redFlag > 0 ? <text
        x={235 + 210 * Math.cos((Math.PI / 180) * (180 - redFlagPosition))}
        y={195 - 200 * Math.sin((Math.PI / 180) * (180 - redFlagPosition))}
        textAnchor="middle"
        fill="#000000"
        fontSize="20px"
    >{redFlag} {unit}</text> : null;

    const targetLabel = target > 0 ? <text
        x={235 + 210 * Math.cos((Math.PI / 180) * (180 - targetPosition))}
        y={190 - 200 * Math.sin((Math.PI / 180) * (180 - targetPosition))}
        textAnchor="middle"
        fill="#000000"
        fontSize="20px"
    >{target} {unit}</text> : null;
