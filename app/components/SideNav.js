...
import { faChartBar, faScrewdriverWrench, faCheckDouble, faGaugeHigh } from '@fortawesome/free-solid-svg-icons'
...
export default function SideNav() {
    ...
    return (
        <div className="">
            <nav className="flex items-center justify-between w-full px-8 py-4 bg-blue-900 lg:hidden">
                <div className="w-full px-2 xl:w-auto xl:mr-12">
                    <div className="flex items-center justify-between">
                        <Link className="inline-flex items-center h-8" href="/">
            ...
            <div className="relative z-50 hidden lg:block navbar-menu">
                ...
                <nav className="fixed top-0 bottom-0 left-0 flex flex-col w-full h-full py-8 pl-5 overflow-auto bg-gradient-to-r from-blue-900 to-blue-700 max-w-xxs shadow-super-2 shadow-black">
                    <div className="mb-6">
                        ...
                        <ul className="mb-8">
                            <li className="mb-1">
                                <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                            ...
                            <li className="mb-1">
                                <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                    ...
                                    <span className="ml-4 text-sm font-semibold">To Dos</span>
                                </Link>
                            </li>
                            <li className="mb-1">
                                <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/kpi-dashboard">
                                    <FontAwesomeIcon icon={faGaugeHigh} size="lg" />
                                    <span className="ml-4 text-sm font-semibold">KPIs</span>
                                </Link>
                            </li>
                            <li className="mb-1">
                                <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                            ...
                            <li className="mb-1">
                                <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                    ...
                                    <span className="ml-4 text-sm font-semibold">Tools</span>
                                </Link>
                            </li>
                            <li>
                                <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                    ...
                                    <span className="ml-4 text-sm font-semibold">Training</span>
                                </Link>
                            </li>
                        </ul>
                        <div>
                            <span className="block mb-8 text-xs font-semibold text-gray-100 uppercase">Teams</span>
                            <ul>
                                <li>
                                    <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                ...
                                <li>
                                    <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                        ...
                                        <span className="text-sm font-semibold">Deal Analysis</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                        <div className="w-2 h-2 mr-2 bg-yellow-400 rounded-full"></div>
                                        <span className="text-sm font-semibold">Acquisition Management</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="/">
                                        <div className="w-2 h-2 mr-2 bg-red-400 rounded-full"></div>
                                        <span className="text-sm font-semibold text-gray-100">Marketing</span>
                                    </Link>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="mt-auto">
                        <Link className="flex items-center p-4 text-gray-100 hover:bg-blue-800 rounded-xl" href="/">
                            <span className="text-gray-100">
            ...
            <div className="mx-auto lg:ml-72"></div>
        </div>
    )
}