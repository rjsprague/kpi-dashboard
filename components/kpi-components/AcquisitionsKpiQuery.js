...
const AcquisitionsKpiQuery = ({
    ...
    console.log("onDateRangeChange: ", onDateRangeChange)
    console.log("onLeadSourceChange: ", onLeadSourceChange)
    console.log("onToggleQuery: ", onToggleQuery)
    console.log("onRemoveQuery: ", onRemoveQuery)
    console.log("onFetchedKpiData: ", onFetchedKpiData)
    console.log("onSetLoading: ", onSetLoading)
