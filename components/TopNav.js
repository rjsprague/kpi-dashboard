...
export default function TopNav() {
    ...
    return (
        <section>
            <div className="flex flex-col h-full p-4 bg-blue-800">
                <div className="flex items-center justify-center w-auto md:justify-between ">
                    <div className="px-2 mb-6 text-center sm:w-full md:w-auto lg:mb-0 md:text-left">
                    ...
                    <div className="items-center px-2 align-middle sm:w-full md:w-auto">
                        <div className="flex flex-row justify-center gap-2">
                            <div className="w-full mb-2 lg:mb-6 sm:w-auto sm:mb-0 sm:mr-4">
                                <div className="flex items-center">
                                    <a className="inline-flex items-center justify-center w-12 h-12 p-1 mb-2 mr-2 text-gray-100 transition duration-150 bg-blue-500 rounded-full md:mr-4 hover:bg-blue-400 hover:bg-opacity-40" href="#">
                                    ...
                                    <a className="inline-flex items-center justify-center w-12 h-12 p-1 mb-2 text-gray-100 transition duration-150 bg-blue-500 rounded-full hover:bg-blue-400 hover:bg-opacity-40" href="#">
                            ...
                            <div className="w-auto">
                                <a className="inline-flex items-center justify-center p-2 transition duration-150 bg-blue-500 rounded-full hover:bg-blue-400 hover:bg-opacity-40" href="#">
                                    <img className="object-cover w-8 h-8 mr-3 rounded-full lg:h-8" src="/Ryan.webp" alt="" />
                                        <h4 className="overflow-hidden tracking-wide text-white whitespace-nowrap lg:font-extrabold">Ryan Sprague</h4>
