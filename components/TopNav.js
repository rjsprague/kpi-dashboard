...
export default function TopNav() {
    ...
    return (
        <section>
            <div className="flex flex-col h-full bg-blue-800 p-4">
                <div className="flex flex-wrap items-center justify-center md:justify-between w-auto ">
                    <div className="sm:w-full md:w-auto px-2 mb-6 lg:mb-0 text-center md:text-left">
                        <h4 className="text-2xl font-bold text-white tracking-wide leading-7 mb-1">Header</h4>
                        <p className="hidden md:block text-xs text-gray-100">Get your work done!</p>
                    </div>
                    <div className="sm:w-full md:w-auto px-2">
                        <div className="items-center flex flex-row gap-2 justify-center">
                            <div className="w-full sm:w-auto mb-6 sm:mb-0 sm:mr-4">
                                <div className="flex flex-wrap items-center -mb-2">
                                    <a className="inline-flex items-center justify-center w-12 h-12 mb-2 mr-2 md:mr-4 p-1 text-gray-100 bg-blue-500 hover:bg-blue-400 hover:bg-opacity-40 transition duration-150 rounded-full" href="#">
                                    ...
                                    <a className="inline-flex items-center justify-center w-12 h-12 mb-2 p-1 text-gray-100 bg-blue-500 hover:bg-blue-400 hover:bg-opacity-40 transition duration-150 rounded-full" href="#">
                            ...
                            <div className="w-full sm:w-auto">
                                <a className="inline-flex items-center justify-center py-2 pl-2 pr-3 bg-blue-500 hover:bg-blue-400 hover:bg-opacity-40 transition duration-150 rounded-full" href="#">
