            ...
            <div className="hidden lg:block navbar-menu relative z-50">
                ...
                <nav className="fixed top-0 left-0 bottom-0 w-full max-w-xxs flex flex-col h-full pl-4 py-8 bg-blue-900 overflow-auto">
                    <div className="mb-6">
                        ...
                        <ul className="mb-8">
                            <li className="mb-1">
                                <a className="flex items-center p-4 text-gray-100 hover:bg-blue-500 focus:bg-blue-700 rounded-tl-xl rounded-bl-xl" href="#">
                    ...
                    <div className="mt-auto">
                        <a className="flex items-center p-4 text-gray-100 hover:bg-blue-800 rounded-xl" href="#">
                            <span className="text-gray-100">
